...
class ReactAgent:
    ...
    def __init__(self, model,prompttemplate,outputtrace) -> None:
        """
    ...
    def load_template(self,prompttemplate) -> str:
        """
        ...
        """
        return read_file(self.prompttemplate)
    ...
    def trace(self, role: str, content: str) -> None:
        ...
        write_to_file(path=self.outputtrace, content=f"{role}: {content}\n")
    ...
    def think(self) -> None:
        ...
        write_to_file(path=self.outputtrace, content=f"\n{'='*50}\nIteration {self.current_iteration}\n{'='*50}\n")
